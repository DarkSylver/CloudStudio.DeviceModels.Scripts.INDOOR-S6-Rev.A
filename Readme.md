...
# Parsing + Configuration Script – INDOOR-S6 - Rev. A

This **Parsing + Configuration** script is designed for the **INDOOR-S6** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – INDOOR-S6 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **INDOOR-S6** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
